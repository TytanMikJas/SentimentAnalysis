...
def split_data(path_to_processed_data, path_to_split_data, test_size, stratify):
    dataset = load_dataset(path_to_processed_data)

    X = dataset.drop(columns=["LABEL-rating"])
    y = dataset["LABEL-rating"]
...
if __name__ == "__main__":
    ...
    split_data(path_to_processed_data, path_to_split_data, test_size, stratify)
